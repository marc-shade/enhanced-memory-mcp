...
class CompressedContextManager:
    ...
    def load_compressed_session_context(
        self, session_id: Optional[str] = None, max_entries: int = 15
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            filtered_entries = self.filter.filter_session_logs(
                session_entries, max_entries
            )
    ...
    def get_selective_raw_logs(
        ...
        try:
            ...
            return {
                ...
                "filters": {"entry_types": entry_types, "tool_names": tool_names},
                "entries": filtered_entries,
            }
    ...
    def create_context_summary(self, session_id: str) -> Dict[str, Any]:
        ...
        try:
                        ...
                        if entry_type == "user":
                            ...
                            for item in content:
                                if item.get("type") == "tool_use":
                                    ...
                                    stats["tool_calls"][tool_name] = (
                                        stats["tool_calls"].get(tool_name, 0) + 1
                                    )
            ...
            return {"status": "success", "session_id": session_id, "summary": stats}
