#!/usr/bin/env python3
"""
Intelligent Model Router for Enhanced Memory MCP Server

Routes tasks between local and cloud Ollama models based on:
- Task complexity
- Reasoning requirements
- Multi-step processing needs
- Resource availability

Local models (fast, frequent operations):
- deepseek-r1:32b-qwen-distill-fp16 for reasoning tasks
- gpt-oss:120b for complex local processing

Cloud models (powerful, periodic operations):
- gpt-oss:20b-cloud for maximum capability tasks
"""
